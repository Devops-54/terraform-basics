...
/* 
    We are going to create single terraform code and this should have the capability to create multiple environments just based on supplying diffeent varaible files.
